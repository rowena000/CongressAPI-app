...
public class BillFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("ACTIVE BILLS").setIndicator("ACTIVE BILLS"), BillActiveListFragment.class, null);
        mTabHost.addTab(mTabHost.newTabSpec("NEW BILLS").setIndicator("NEW BILLS"), BillNewListFragment.class, null);
